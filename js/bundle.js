...
var _Sidebar = __webpack_require__(/*! ./Sidebar */ "./src/js/Sidebar.jsx");

var _Sidebar2 = _interopRequireDefault(_Sidebar);

var _Main = __webpack_require__(/*! ./Main */ "./src/js/Main.jsx");
...
var _ProjectList = __webpack_require__(/*! ./ProjectList */ "./src/js/ProjectList.jsx");

var _ProjectList2 = _interopRequireDefault(_ProjectList);

var _sitedata = __webpack_require__(/*! ./sitedata */ "./src/js/sitedata.js");
...
var _Project = __webpack_require__(/*! ./Project */ "./src/js/Project.jsx");
...
var ProjectList = function (_React$Component) {
    ...
    _createClass(ProjectList, [{
        key: 'render',
        value: function render() {
            var projects = this.props.data.map(function (item, index) {
                return _react2.default.createElement(_Project2.default, { key: index, data: item });
            });
            return _react2.default.createElement(
                'ul',
                { className: 'projects' },
...
var _Social = __webpack_require__(/*! ./Social */ "./src/js/Social.jsx");
...
function Social(props) {
    ...
    var items = props.data.map(function (item, index) {
        return _react2.default.createElement(
            "li",
            { className: "social--item", key: index },
            _react2.default.createElement(
                "a",
                { href: item.link },
                _react2.default.createElement("i", { className: item.class })
            )
        );
    });
